                        ...
                        {['country', 'state'].map((field, index) => (
                            <div className="relative" key={index}>
                                ...
                                >
                                    ...
                                    <option value={`${field}1`}>{`${field.charAt(0).toUpperCase() + field.slice(1)} 1`}</option>
                                    <option value={`${field}2`}>{`${field.charAt(0).toUpperCase() + field.slice(1)} 2`}</option>
                                    <option value={`${field}3`}>{`${field.charAt(0).toUpperCase() + field.slice(1)} 3`}</option>
                                </select>
                                <label
                                    htmlFor={field}
                                    className="absolute px-1 text-sm text-gray-500 transition-all duration-300 transform scale-75 -translate-y-4 bg-white top-2 left-4"
